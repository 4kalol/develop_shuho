            ...
            <div class="overflow-hidden shadow-sm">
                    ...
                    <table class="table-auto w-full text-left">
                        ...
                        <tr class="border border-blue border-2">
                            <td class="w-1/5 mx-100 pl-3 pr-0 pb-12 text-sm font-bold text-gray-500">{{ $shuho->name }}</td>
                            @php
                            if ($shuho->level == "good")
                            {
                                $strLevel = "順調";
                            ...
                            @endphp
                            <td class="w-1/5 px-4 py-8 {{ $colorcheck }} text-lg font-bold">{{ $strcheck }}</td>
                            ...
                            <td class="w-1/5 pt-11 pr-4 text-xs text-right font-bold text-gray-500">{{ $shuho->created_at }}</td>
                        </tr>
                        @endforeach
                        </tbody>
                    </table>

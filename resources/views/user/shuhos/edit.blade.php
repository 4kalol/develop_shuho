            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="container px-5 mx-auto">
                        ...
                        <p class="lg:w-2/3 mx-auto leading-relaxed text-base">報告編集</p>
                        </div>
                        ...
                        <div class="flex flex-wrap -m-2">
                            ...
                            <div class="p-2 w-full">
                            <button class="flex mx-auto text-white bg-gray-500 border-0 py-2 px-8 focus:outline-none hover:bg-gray-600 rounded text-lg">更新</button>
                            </div>
                    ...
                    <a href="{{ route('user.shuhos.show', $shuho->id) }}" class="hidden sm:block text-blue-500">キャンセル</a>
                </div>
            </div>
        </div>
    </div>
